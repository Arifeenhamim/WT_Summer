...
<table>
        ...
        </td><td><p id="nameerror"></p></td> <td><?php echo $nameErr; ?></td></tr>
        <tr><td>
        Last Name:
        </td><td>
        <input type="text" name="lname" id="lname" onkeyup="checklname()">
        </td><td><p id="lnameerror"></p></td><td><?php echo $name2Err; ?></td></tr>
        <tr><td>
        Age:
        </td><td>
        <input type="text" name="age" id="age" onkeyup = "agecheck()">
        </td><td><p id="ageerror"></p></td><td><?php echo $AgeErr; ?></td></tr>
        <tr><td>
        Designation:
        </td><td>
        ...
        </td><td><p id="radiovalue"></p><td><?php echo $desigErr; ?></td></tr>
        <tr><td>
        Preferred language:
        </td><td>
        ...
        </td><td><p id="checkvalue"></p></td><td><?php echo $LanErr; ?></td></tr>
        <tr><td>
        E-mail:
        </td><td>
        <input type="email" name="email" id ="email" onkeyup = "validateemail()">
        </td><td><p id="emailvalue"></p></td><td><?php echo $emailErr; ?></td></tr>
        <tr><td>
        Enter a Password:
        </td><td>
        <input type="password" name="pass" id="pass" onkeyup = "passcheck()">
        </td><td><p id="passvalue"></p></td><td><?php echo $passErr; ?></td></tr>
        <tr><td>
        Please choose a file
        </td><td>
        <input type="file" name="myfile">
        <!-- </td><td><?php echo $fileErr; ?></td></tr> -->
